...
export const createNote = async (formData: FormData) => {
  const response = await axios.post(`${BASE_URL}/create-note`, formData, {
...
export const updateNoteApi = async (noteId: string, data: FormData) => {
  return await axios.put(`${BASE_URL}/update-note/${noteId}`, data, {
    withCredentials: true,
...
export const toggleChecklistApi = async (
  noteId: string,
